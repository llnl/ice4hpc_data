...
============================
module load rocm/6.4.2 rocmcc/6.4.2-cce-20.0.0-magic cray-mpich/9.0.1 cmake/3.29.2

export PREFIX=/p/lustre5/ice4hpc/apps/install-tuolumne
ENABLE_CUDA=OFF
ENABLE_HIP=ON
export HIP_ARCH=gfx942

export CXX=/usr/tce/packages/cray-mpich/cray-mpich-9.0.1-rocmcc-6.4.2-cce-20.0.0-magic/bin/mpiamdclang++
export CC=/usr/tce/packages/cray-mpich/cray-mpich-9.0.1-rocmcc-6.4.2-cce-20.0.0-magic/bin/mpiamdclang
...
-DCMAKE_PREFIX_PATH=/opt/rocm-6.4.2/lib/cmake \
-DMPI_INCLUDE_DIR=/usr/tce/packages/cray-mpich/cray-mpich-9.0.1-rocmcc-6.4.2-cce-20.0.0-magic/include \
../src
...
cmake -DCMAKE_INSTALL_PREFIX=${PREFIX} -DMFEM_USE_HIP=ON -DCMAKE_HIP_ARCHITECTURES=${HIP_ARCH} ..
