...
Build:
  ...
  copy llnl-toss4-MI250X-rocm6.4.2-adams.cmake to the build directory
  cmake -DENABLE_MPI=ON -DENABLE_HIP=ON -DCMAKE_CXX_FLAGS="-g" -DCMAKE_C_FLAGS="-g" -C llnl-toss4-MI250X-rocm6.4.2-adams.cmake ..
  make -j 16
