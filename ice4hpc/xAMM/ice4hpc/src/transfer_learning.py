    ...
    for nu_of_frozen_layers in use_case_specific_config["num_of_frozen_layers"]:
      for i in range(rank, rank+1):
        ...
        for j in test_samples:
          ...
          source_model = util.sorceModelLoader( A_X_train, A_Y_train, self.transfer_permission, nu_of_frozen_layers, False, global_config, target_app, False,os.getcwd()+global_config["source_model1"], os.getcwd()+global_config["source_model_weights1"])
