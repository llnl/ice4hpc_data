...
class Bagging():
  ...
  def __call__(self, config_yaml, A_X_train, A_Y_train, A_tar_x_scaled, A_tar_y_scaled, B_X_train, B_Y_train, B_tar_x_scaled, B_tar_y_scaled):
    ...
    """
    #params = {'bootstrap': True, 'bootstrap_features': True, 'n_estimators': 10} #model.best_params_

    rp_source_model = BaggingRegressor(bootstrap=True, bootstrap_features=True, n_estimators= 10, max_features = 0.5, max_samples=0.5) #**model.best_params_)
    ...
    rc_source_model = BaggingRegressor(bootstrap=True, bootstrap_features=True, n_estimators= 10, max_features = 0.5, max_samples=0.5) #(**params)
