...
class XGBoost():
  ...
  def __call__(self, config_yaml, A_X_train, A_Y_train, A_tar_x_scaled, A_tar_y_scaled, B_X_train, B_Y_train, B_tar_x_scaled, B_tar_y_scaled):
    ...
    """
    rp_source_model = GradientBoostingRegressor(criterion='squared_error', learning_rate=0.01,
                          loss='huber', max_depth=5, max_features='log2',
                          n_estimators=10) #(**model.best_params_)
    ...
    rc_source_model = GradientBoostingRegressor(criterion='squared_error', learning_rate=0.01,
                          loss='huber', max_depth=5, max_features='log2',
