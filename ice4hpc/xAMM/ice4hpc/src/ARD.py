...
class ARD():
  ...
  def __call__(self, config_yaml, A_X_train, A_Y_train, A_tar_x_scaled, A_tar_y_scaled, B_X_train, B_Y_train, B_tar_x_scaled, B_tar_y_scaled):
    ...
    #A_X_train_imputed = imputer.fit_transform(A_X_train)
    #B_X_train_imputed = imputer.fit_transform(B_X_train)
    ...
    print("Features in training set:", A_X_train.shape[1])
    ...
    rp_source_model = ARDRegression(**model.best_params_)
    ...
    rc_source_model = ARDRegression(**params)
